    ...
    <React.Fragment>
      <HeadingWrapper>
        <Heading>
          ...
          <HeadingLarge primary>Ashutosh Tripathi</HeadingLarge>
          <HeadingLarge>Frontend Software Developer.</HeadingLarge>
        </Heading>
        <InfoPara>
          Focused on making creative digital experiences with slick designs. <br /> Currently converting some Words into Code.
        </InfoPara>
        <Button value="My Resume" target="_blank" href="yhttps://drive.google.com/file/d/1SNZQ3HeHXskvK8qQsKjI8NbexbjNrDHE/view?usp=sharing" size="1.3rem"></Button>
      </HeadingWrapper>
