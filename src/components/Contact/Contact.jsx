      ...
      <Zoom>
        <ContactWrapper id={props.id}>
          <ContactData style={{padding:"1rem"}}>
            ...
            <ContactHeading style={{ color: '#64FFDA', textDecoration:"none", fontSize:"24px", border: '4px solid #64FFDA', padding: '10px', borderRadius: "12px", letterSpacing: '1px'}}>📧 Email: Ashutoshtr2427@gmail.com </ContactHeading>
            <ContactHeading style={{ color: '#64FFDA', textDecoration:"none", fontSize:"24px", border: '4px solid #64FFDA', padding: '10px', borderRadius: "12px", marginTop:"1rem", letterSpacing: '1px'}}>📞 Phone: 8174862890  </ContactHeading>
